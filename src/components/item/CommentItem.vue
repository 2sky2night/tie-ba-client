        ...
        <div class="header ">
            <div class="username">
                <RouterLink :to="`/user/${comment.uid}`">
                    <img v-lazyImg="comment.user.avatar">
                </RouterLink>
                <RouterLink class="ml-10" :to="`/user/${comment.uid}`">
                    <span class="text">{{ comment.user.username }}</span>
                </RouterLink>
            </div>
            <follow-btn :uid="comment.user.uid" :is-fans="comment.user.is_fans"
                v-model:is-followed="comment.user.is_followed" size="small"></follow-btn>
        </div>
        <div class="content">
            <p>{{ comment.content }}</p>
