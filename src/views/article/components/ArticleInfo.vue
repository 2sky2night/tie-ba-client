  ...
  <div class="article-info-container">
    <template v-if="articleInfo">
      <div class="article-info">
        ...
        <div class="actions">
          <auth-btn>
            <n-button round :disabled="likeIsLoading">
          ...
          <auth-btn>
            <n-button round :disabled="starIsLoading">
      ...
      <!--移动端会显示的操作面板-->
      <Actions v-if="showAction" 
      :to-star-handle="toStarArticle" 
      :is-like="articleInfo.is_liked" 
      :to-like-handle="toLikeArticle" 
      :is-star="articleInfo.is_star" 
      :like-is-loading="likeIsLoading" 
      :star-is-loading="starIsLoading" 
      :aid="articleInfo.aid" 
      v-model:comment-count="articleInfo.comment_count"
      />
    </template>
  </div>
</template>
